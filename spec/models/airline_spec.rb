...
RSpec.describe Airline, type: :model do
  ...
  describe 'instance methods' do
    describe '.airline_passengers' do
      it 'returns a unique list of all passengers with flights on that airline orderd by number of flights' do
        ...
        expect(@airline_1.airline_passengers.last.name).to eq('Judice')
      end
    end
  end
end
